...
// in simulator we redefine to format for LoanCalc Developer console
...
{\
	NSString * exceptionName = [@"org.loancalc." stringByAppendingString:NSStringFromClass([self class])];\
...
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.loancalc";\
	NSString * message = [NSString stringWithFormat:@"%@. %@ %@",reason,(subreason!=nil?subreason:@""),(location!=nil?location:@"")];\
	TiExceptionThrowWithNameAndReason(exceptionName,message);\
}\
...
enum {
	UILoanCalcNativeItemNone = -1, 
	UILoanCalcNativeItemSpinner = -2,
	UILoanCalcNativeItemProgressBar = -3,
	
	UILoanCalcNativeItemSlider = -4,
	UILoanCalcNativeItemSwitch = -5,
	UILoanCalcNativeItemMultiButton = -6,
	UILoanCalcNativeItemSegmented = -7,
	
	UILoanCalcNativeItemTextView = -8,
	UILoanCalcNativeItemTextField = -9,
	UILoanCalcNativeItemSearchBar = -10,
	
	UILoanCalcNativeItemPicker = -11,
	UILoanCalcNativeItemDatePicker = -12,
	
	UILoanCalcNativeItemInfoLight = -13,
	UILoanCalcNativeItemInfoDark = -14,
	
	UILoanCalcNativeItemDisclosure = -15,
	
	UILoanCalcNativeItemContactAdd = -16
};
