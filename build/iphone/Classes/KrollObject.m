 ...
 * Copyright (c) 2009-2011 by LoanCalc, Inc. All Rights Reserved.
...
//@interface LoanCalcObject : NSObject
//@end

@interface LoanCalcObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[LoanCalcObject class]])
		{
			for (NSString *key in [[(LoanCalcObject*)o modules] allKeys])
			{
